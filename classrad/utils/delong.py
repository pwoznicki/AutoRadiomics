"""
Borrowed from WORC: https://worc.readthedocs.io/en/latest/_modules/WORC/statistics/delong.html
"""
    ...
    Reference:
     @article{sun2014fast,
       title={Fast Implementation of DeLong's Algorithm for Comparing the
        Areas Under Correlated Receiver Oerating Characteristic Curves},
